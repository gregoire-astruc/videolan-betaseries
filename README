...
[[BetaSeries|http://www.betaseries.com/]] enables TV series fans to keep track with their favorite
shows.
...
1. Get the extension.
~~~~~~~~~~~~~~~~~~~~~
* Download the extension from the [[Download link|https://github.com/gregoire-astruc/videolan-betaseries]] on the project main page.
...
* **Linux**:
  ...
  * Download and run the [[Install Script|
    https://github.com/downloads/gregoire-astruc/videolan-betaseries/install-videolan-betaseries.sh]]
    available on the project main page.
...
* **Others**:
  ...
  * Extract the archive directory content (the one from which you can see modules, meta
    ...
    it can be in any directory mentioned in the [[VLC lua README|
    http://git.videolan.org/?p=vlc.git;a=blob_plain;f=share/lua/README.txt]] §2.
...
* Run VLC. If the extension is installed properly, it should appear in the 'View' menu.